	...
	<header>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse justify-content-center mx-4"
					...
					<ul class="navbar-nav">
						...
						href="./Hospedagem"target="_self">Hospedagem</a>
						</li>								
						<li class="nav-item">
						<a class="nav-link"	href="../Permissoes.html">Permissão</a>
						</li>						
						<li class="nav-item">
						<a class="nav-link"href="../UsuarioCliente/index.html">Cadastro</a>
						</li>							
					</ul>
				</div>
			</div>
		...
		<div class="header2">
			<h1 class="titulo-cadast text-center">
				<strong>Atualizar | Hospedagem</strong>
			</h1>
		</div>
	</header>
	<main class=" container-row g-3 col-md-11 mx-auto col-lg-9 mb-2 ">
		      
              <form action="./hospedagem-update" method="post" class="row g-3 needs-validation" id="form-create" novalidate>
              <fieldset>	
                <div class="mb-0 mt-2">
                    <h3 class="text-center"><strong>Atualizar</strong></h3>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-outline">
                        ...
                        <input type="text" id="validationCustom01" class="form-control"
                            placeholder="nome do hotel ou pousada" value="<%=request.getAttribute("nome") %>" />
                ...
                <div class="col-md-6">
                    <div class="form-outline">
                        ...
                        <input type="text" class="form-control" id="validation02" placeholder="Cidade / Estado" 
                        value="<%=request.getAttribute("cidadeEstado") %>"/>
                        <div class="valid-feedback">
                            <i class="ico ri-check-fill text-success"></i>
                        </div>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="form-outline">
                        ...
                        <input type="text" class="form-control" id="validationCustom05" placeholder="Preço por diárias"
                            value="<%=request.getAttribute("preco_hospedagem") %>"/>
                        <div class="valid-feedback">
                            <i class="ico ri-check-fill text-success"></i>
                        </div>
                    </div>
				...
				<a href="./hospedagem" class="btn btn-outline-danger text-black rounded-5 buttonBase mb-3 py-2 mx-3">Cancelar</a>							
					</div>
				</fieldset>
			</form>	
	</main>
